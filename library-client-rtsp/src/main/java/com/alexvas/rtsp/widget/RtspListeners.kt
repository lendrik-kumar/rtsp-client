...
interface RtspDataListener {
    fun onRtspDataVideoNalUnitReceived(data: ByteArray, offset: Int, length: Int, timestampUs: Long, isKeyframe: Boolean) {}
    fun onRtspDataAudioSampleReceived(data: ByteArray, offset: Int, length: Int, timestampUs: Long) {}
    fun onRtspDataApplicationDataReceived(data: ByteArray, offset: Int, length: Int, timestampUs: Long) {}
}
